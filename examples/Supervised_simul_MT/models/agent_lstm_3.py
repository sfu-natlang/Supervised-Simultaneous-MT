...
@register_model("agent_lstm_3")
class AgentLSTMModel3(FairseqLanguageModel):
...
class LSTMDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(
        ...
        self.tkn_embed_tokens = Linear(1025, 2*embed_dim)
    ...
    def extract_features(
        ...
        x_nmt = self.tkn_embed_tokens(tokens)
...
@register_model_architecture("agent_lstm_3", "agent_lstm_3")
...
@register_model_architecture("agent_lstm_3", "agent_lstm_3_med")
def base_architecture(args):
    args.dropout = getattr(args, "dropout", 0.1)
...
@register_model_architecture("agent_lstm_3", "agent_lstm_3_big")
def base_architecture(args):
    args.dropout = getattr(args, "dropout", 0.1)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 512)
    args.decoder_embed_path = getattr(args, "decoder_embed_path", None)
...
@register_model_architecture("agent_lstm_3", "agent_lstm_3_big2")
def base_architecture(args):
    args.dropout = getattr(args, "dropout", 0.1)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 512)
    args.decoder_embed_path = getattr(args, "decoder_embed_path", None)
...
@register_model_architecture("agent_lstm_3", "agent_lstm_3_big3")
def base_architecture(args):
    args.dropout = getattr(args, "dropout", 0.1)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 512)
    args.decoder_embed_path = getattr(args, "decoder_embed_path", None)
