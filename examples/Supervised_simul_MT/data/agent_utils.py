...
def prepare_input_type1(hypos, sample, src_pad, trg_pad, agt_dict):
    agt_pad = agt_dict.pad_index
    net_input = generate_incremental_net_input(hypos, num_src=1, src_pad=src_pad, trg_pad=trg_pad)
...
def prepare_input_type2(hypos, sample, agt_dict):
    agt_pad = agt_dict.pad_index
